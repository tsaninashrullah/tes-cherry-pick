  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        <li class="active"><a href="<?=site_url('news')?>">Home <span class="sr-only">(current)</span></a></li>
        <li><a href="<?=site_url('news/list')?>">List</a></li>
        <li class="dropdown">
      ...
      <ul class="nav navbar-nav navbar-right">
        ...
        if ($username != "") {?>
          <li class="dropdown">
            ...
            <ul class="dropdown-menu">
              <li><a href="#">Hello (<?=ucwords($username)?>)</a></li>
              <li role="separator" class="divider"></li>
        ...
        <?php
          ...
          <li><a href="<?=site_url('auth/login')?>">Login yuk!</a></li>
        <?php
        }
        ?>
      </ul>
